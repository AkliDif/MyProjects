...
Tuile* depiler_tuile (Pile *P)
{
    ...
    Tuile* T = creer_tuile (P->T[P->nb_tuile-1].cote_A->type, P->T[P->nb_tuile-1].cote_B->type, P->T[P->nb_tuile-1].cote_C->type, P->T[P->nb_tuile-1].cote_D->type, P->T[P->nb_tuile-1].cote_E->type, P->T[P->nb_tuile-1].nb);
    P->nb_tuile --;
    return T;
}
