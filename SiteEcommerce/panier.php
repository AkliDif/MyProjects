...
if(isset($_POST['payer']))
{
	...
	if(!isset($erreur))
	{
		...
		unset($_SESSION['panier']);
		mail($_SESSION['membre']['email'], "confirmation de la commande", "Merci votre n° de suivi est le $id_commande", "From:difakli049@gmail.com");
...
echo "</table><br />";
echo "<i>Réglement par CHÉQUE uniquement à l'adresse suivante : 28 Boulevard Gaspard Monge 91120 Palaiseau</i><br />";
