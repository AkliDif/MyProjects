...
if(isset($_GET['action']) && ($_GET['action'] == 'ajout' || $_GET['action'] == 'modification'))
{
	...
	<form method="post" enctype="multipart/form-data" action="">
		...
		<select name="categorie">
			...
			<option value="Chemise"'; if(isset($produit_actuel) && $produit_actuel['categorie'] == 'Chemise') echo ' selected '; echo '>Chemise</option>
			<option value="Pontalon"'; if(isset($produit_actuel) && $produit_actuel['categorie'] == 'Pontalon') echo ' selected '; echo '>Pontalon</option>
		</select><br /><br />
