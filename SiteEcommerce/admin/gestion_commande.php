...
//-------------------------------------------------- Affichage ---------------------------------------------------------//
	...
	$information_sur_les_commandes = executeRequete("SELECT commande.*, membre.pseudo, membre.adresse, membre.ville, membre.code_postal FROM commande left join membre on  membre.id_membre = commande.id_membre");
