...
if(isset($_POST['payer']))
{
	...
	if(!isset($erreur))
	{
		executeRequete("INSERT INTO commande (id_client, montant, date_enregistrement) VALUES (" . $_SESSION['client']['id_client'] . "," . montantTotal() . ", NOW())");
		...
		unset($_SESSION['panier']);
		mail($_SESSION['client']['email'], "confirmation de la commande", "Merci votre n° de suivi est le $id_commande", "From:monsitel2info@gmail.com");
...
else
{
	...
	{
		echo '<tr><td colspan="3">Veuillez vous <a href="inscription.php">inscrire</a> ou vous <a href="connexion.php">connecter</a> afin de pouvoir passer votre commande</td></tr>';
	}
