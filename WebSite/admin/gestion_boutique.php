...
{	// debug($_POST);
	...
	executeRequete("REPLACE INTO produit (reference, categorie, titre, marque,  description, couleur, taille, public, photo, prix, stock) values ('$_POST[reference]', '$_POST[categorie]', '$_POST[titre]', '$_POST[marque]', '$_POST[description]', '$_POST[couleur]', '$_POST[taille]', '$_POST[public]',  '$photo_bdd',  '$_POST[prix]',  '$_POST[stock]')");
	$contenu .= '<div class="validation">Le produit a été bien ajouter</div>';
	$_GET['action'] = 'affichage';
}
//--- LIENS PRODUITS ---//
...
if(isset($_GET['action']) && ($_GET['action'] == 'ajout' || $_GET['action'] == 'modification'))
{
	...
	echo '
	<h1 class="forms-titles"> Formulaire Produits </h1>
	<form method="post" enctype="multipart/form-data" action="" class="forms">
		...
		<select name="categorie">
			...
			<option value="Chemise"'; if(isset($produit_actuel) && $produit_actuel['categorie'] == 'Short') echo ' selected '; echo '>Short</option>
			<option value="Pontalon"'; if(isset($produit_actuel) && $produit_actuel['categorie'] == 'Pantalon') echo ' selected '; echo '>Pantalon</option>
		</select><br /><br />
